...
- How can I create publication-quality plots from data in R?
- How do I map data variables to visual properties in ggplot2?
- How can I customise the appearance of a plot?
- How do I save plots to a file?
...
![](fig/blank-graph-1.png){alt='A blank ggplot canvas with no axes or data plotted.'}
...
![](fig/with-axis-1.png){alt='A ggplot canvas with weight on the x-axis and hindfoot_length on the y-axis but no data points.'}
...
![](fig/first-ggplot-1.png){alt='Scatter plot of weight versus hindfoot length for all species in the surveys_complete dataset.'}
...
![](fig/first-ggplot-with-plus-1.png){alt='Scatter plot of weight versus hindfoot length generated by adding geom_point to a stored ggplot object.'}
...
![](fig/create-ggplot-object-1.png){alt='Basic scatter plot of weight versus hindfoot length.'}
...
![](fig/adding-transparency-1.png){alt='Scatter plot of weight versus hindfoot length with transparent points to show overplotting.'}
...
![](fig/adding-colors-1.png){alt='Scatter plot of weight versus hindfoot length with all points coloured blue.'}
...
![](fig/color-by-species-1-1.png){alt='Scatter plot of weight versus hindfoot length with points coloured by species ID.'}
...
![](fig/unnamed-chunk-4-1.png){alt='Scatter plot of weight by species ID with points coloured by plot type.'}
...
![](fig/boxplot-1.png){alt='Boxplot showing the distribution of weight for each species ID.'}
...
![](fig/boxplot-with-points-1.png){alt='Boxplot with jittered data points overlaid in tomato red showing the distribution of weight by species ID.'}
...
![](fig/first-time-series-1.png){alt='Line plot of counts over years with all genera combined into a single line.'}
...
![](fig/time-series-by-species-1.png){alt='Line plot of counts over years with a separate line for each genus.'}
...
![](fig/time-series-with-colors-1.png){alt='Line plot of counts over years with each genus shown in a different colour.'}
...
![](fig/integrating-the-pipe-1.png){alt='Line plot of counts over years by genus created by piping data into ggplot.'}
...
![](fig/pipes-and-manipulation-1.png){alt='Line plot of counts over years by genus created by chaining data manipulation and ggplot with pipes.'}
...
![](fig/first-facet-1.png){alt='Faceted line plots showing counts over years for each genus in a separate panel.'}
...
![](fig/facet-colour-1.png){alt='Faceted line plots showing counts over years by genus, with lines coloured by sex.'}
...
![](fig/facet-remove-grid-1.png){alt='Grid of faceted line plots with sex in rows and genus in columns.'}
...
![](fig/facet-rows-1.png){alt='Faceted line plots arranged in a single column with one panel per genus.'}
...
![](fig/facet-column-1.png){alt='Faceted line plots arranged in a single row with one panel per genus.'}
...
![](fig/facet-by-species-and-sex-white-bg-1.png){alt='Faceted line plots by genus and sex using the black and white theme.'}
...
![](fig/challange-theme-bw-1.png){alt='Faceted line plots showing average weight over years for each species ID using the black and white theme.'}
...
![](fig/number-species-year-with-right-labels-1.png){alt='Faceted line plots by genus and sex with descriptive axis labels and a title.'}
...
![](fig/number-species-year-with-right-labels-xfont-size-1.png){alt='Faceted line plots by genus and sex with increased font size on all text elements.'}
...
![](fig/number-species-year-with-theme-1.png){alt='Faceted line plots by genus and sex with rotated x-axis labels for readability.'}
...
![](fig/number-species-year-with-right-labels-xfont-orientation-1.png){alt='Boxplot of hindfoot length by species ID with the custom grey theme applied.'}
...
![](fig/gridarrange-example-1.png){alt='Two plots arranged side by side: a boxplot of species weights on the left and a line plot of genus abundance over time on the right.'}
